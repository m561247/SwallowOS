...
# save elf file in floppy
echo "int main(int argc, char *argv[]) { int a = 3, b = 5, c; c = c + b; return 0; }" > "$MOUNTPOINT/main.c"
${CC} -static -O0 -o $MOUNTPOINT/main $MOUNTPOINT/main.c
